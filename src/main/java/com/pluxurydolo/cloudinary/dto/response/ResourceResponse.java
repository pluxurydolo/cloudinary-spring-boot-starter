...
public record ResourceResponse(
    ...
    @JsonProperty("backup_url") String backupUrl,
    @JsonProperty("context") Map<String, Object> context,
    @JsonProperty("metadata") Map<String, Object> metadata,
    @JsonProperty("colors") Map<String, String> colors,
    @JsonProperty("faces") List<List<Integer>> faces,
    @JsonProperty("derived") List<DerivedResource> derived,
    @JsonProperty("access_mode") String accessMode,
    @JsonProperty("access_control") Object accessControl,
    ...
    @JsonProperty("api_metadata") Map<String, Object> apiMetadata
) {
}
